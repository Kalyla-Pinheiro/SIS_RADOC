...
const DisciplinasMinistradas = () => {
  ...
  const handleDisciplinasMinistradas = async (event) => {
    ...
    try {
      const chaveDocumentoComprobatorio = ano + " - Declaração_Disciplinas_Ministradas";
      ...
      reader.readAsDataURL(pdfDisciplinas);
    } catch (error) {
      console.error("Erro ao processar o PDF:", error);
      ToastifyMessages.error("Erro ao processar o PDF!");
    }
  ...
  const handleDiarioDeTurma = async (event) => {
    ...
    try {
      const chaveDocumentoComprobatorio = ano + " - Declaração_Diários_De_Turma";
      ...
      // Lê o arquivo PDF como uma URL de dados
      reader.readAsDataURL(pdfDiarios);
    } catch (error) {
      console.error("Erro ao processar o PDF:", error);
      ToastifyMessages.error("Erro ao processar o PDF!");
    }
