    ...
    <div>
      ...
      <div className={classes.outrosContainer}>
        ...
        <div className={classes.areaPreenchimento}>
          ...
          <div className={classes.campoTabelasSemestre} id={classes.tabelasMotivacaoDoAfastamento}>
        ...
        <div className={classes.buttons} id={classes.buttonMotivacaoDoAfastamento}>
          <div>
            <a href="#">
